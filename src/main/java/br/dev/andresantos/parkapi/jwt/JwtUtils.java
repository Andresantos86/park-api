...
public class JwtUtils {
  ...
  public static final String SECRET_KEY = "@ndr&-Inov@t1on-2022-d&v-151223*";
  ...
  private static Claims getClainsFormToken (String token){
    try {
  ...
  public static String getUsernameFromToken(String token){
    return getClainsFormToken(token).getSubject();
  }
