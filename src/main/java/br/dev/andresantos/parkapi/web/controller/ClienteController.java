...
import br.dev.andresantos.parkapi.service.ClienteService;
...
import br.dev.andresantos.parkapi.web.mapper.ClienteMapper;
...
public class ClienteController {
  ...
  public ResponseEntity<PageableDto> getAll(Pageable page){
    Page<ClienteProjection> clientes = clienteService.BuscarTodos(page);
